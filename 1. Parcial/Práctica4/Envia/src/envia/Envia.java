...
public class Envia {  
  ...
  public static void main(String[] args) {  
   ...
   try{
    ...
    try {
        archivo = new File ("C:\\Users\\Wicho\\Documents\\ESCOM\\Redes\\Práctica4\\TEXTO.txt");
    ...
    String mensaje= "Un mensaje para el protocolo practica numero 4";
    ...
    for(int c=0;c<tam;c++)
        ...
        System.out.println("El mensaje es muy largo... maximo 1000 bytes");
        System.exit(1);
    }  
    
    ///se define la MAC a la que se enviará
    trama[0]= (byte) 0x70;
    trama[1]= (byte) 0xC9;
    trama[2]= (byte) 0x4A;
    trama[3]= (byte) 0xB4;
        ...
        public void nextPacket(PcapPacket packet, String user) {
				...
				System.out.printf("Paquete recibido el %s bytes capturados=%-4d tam original=%-4d %s\n\n",
				    ...
				    user                                 // User supplied object
                                ...
                                byte[]t = packet.getByteArray(14, 1000);
                                   int longitud =0;
                                ...
                                System.out.println(datos+"jajaja \n\n");
                               ...
                               long checkSum=Checksum.calculateChecksum(packet.getByteArray(14,longitud));
                                if(checkSum!=0){
                                    System.out.printf("\nEl envío es correcnto %02X\n",checkSum);
                                        trama[14]=(byte)((checkSum>>8)&0xFF);
                                    trama[15]=(byte)(checkSum&(0XFF));
                                    for(int l=0;l<packet.size();l++){
                                     System.out.printf("%02X ",trama[l]);
                                     if(l%16==15){
                                     System.out.println("");
                                        }
                                     }
                                    ...
                                    System.out.println("La wea no funciona");
                                }
                                }//if
